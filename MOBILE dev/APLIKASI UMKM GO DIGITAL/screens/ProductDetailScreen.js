...
const styles = StyleSheet.create({
  ...
  categoryTagText: { fontSize: 12, fontWeight: '700', color: '#EE4D2D' },
  nameSection: { paddingHorizontal: 20, paddingTop: 20 },
  productName: { fontSize: 24, fontWeight: '800', color: '#1a1a2e' },
  productPrice: { fontSize: 22, fontWeight: '800', color: '#EE4D2D', marginTop: 6 },
  ...
  editBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#EE4D2D', borderRadius: 16, height: 54, elevation: 4 },
